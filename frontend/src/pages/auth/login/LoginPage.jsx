...
const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-100 flex items-center justify-center px-4 py-4'>
      <div className='bg-white rounded-3xl shadow-2xl border border-white/20 backdrop-blur-sm flex max-w-4xl w-full overflow-hidden relative'>
          ...
          <div className='relative z-10'>
            ...
            <div className='space-y-4'>
              <div className='flex items-center gap-3 text-emerald-100 group hover:text-white transition-colors duration-300'>
                ...
                <span className='text-base'>Chia sẻ địa điểm tuyệt vời</span>
              </div>
              <div className='flex items-center gap-3 text-emerald-100 group hover:text-white transition-colors duration-300'>
                <div className='p-2 bg-white bg-opacity-20 rounded-lg group-hover:scale-110 transition-transform duration-300'>
                  <Camera size={18} />
                </div>
                <span className='text-base'>Lưu giữ kỷ niệm đẹp</span>
              </div>
              <div className='flex items-center gap-3 text-emerald-100 group hover:text-white transition-colors duration-300'>
                <div className='p-2 bg-white bg-opacity-20 rounded-lg group-hover:scale-110 transition-transform duration-300'>
                  <Globe size={18} />
                </div>
                <span className='text-base'>Kết nối cộng đồng du lịch</span>
              </div>
              <div className='flex items-center gap-3 text-emerald-100 group hover:text-white transition-colors duration-300'>
                <div className='p-2 bg-white bg-opacity-20 rounded-lg group-hover:scale-110 transition-transform duration-300'>
                  <Mountain size={18} />
                </div>
                <span className='text-base'>Khám phá điều mới mẻ</span>
              </div>
            </div>
          </div>
            ...
            <div className='relative'>
              <div className='w-64 h-48 bg-gradient-to-t from-white/10 to-white/5 rounded-3xl backdrop-blur-sm border border-white/20 flex items-center justify-center relative overflow-hidden'>
                ...
                <div className='relative z-10 flex items-center justify-center'>
                  <Plane size={48} className='text-white/80' />
                </div>
                ...
                {/* Small travel icons */}
                <MapPin size={20} className='absolute top-8 left-1/3 text-white/60 animate-bounce' />
                <Camera size={16} className='absolute bottom-12 right-8 text-white/60 animate-pulse' />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className='relative z-10'>
            ...
            <div className='mt-8 text-center space-y-3'>
              ...
              <Link to='/SignUp' className='block w-full'>
                <button
                  type='button'
                  className='w-full py-3 px-8 bg-white border-2 border-emerald-600 text-emerald-600 font-bold rounded-2xl hover:bg-emerald-600 hover:text-white hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 text-base'
                >
                  <div className='flex items-center justify-center gap-2'>
