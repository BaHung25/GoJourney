...
const SignUpPage = () => {
  ...
  return (
    ...
    <div className='bg-white rounded-3xl shadow-2xl border border-white/20 backdrop-blur-sm flex max-w-6xl w-full overflow-hidden relative'>
        ...
        <div className='relative z-10'>
          ...
          <div className='space-y-6'>
            <div className='flex items-center gap-4 text-emerald-100 group hover:text-white transition-colors duration-300'>
              ...
              <span className='text-lg'>Tạo bản đồ hành trình của riêng bạn</span>
            </div>
            <div className='flex items-center gap-4 text-emerald-100 group hover:text-white transition-colors duration-300'>
              <div className='p-2 bg-white bg-opacity-20 rounded-lg group-hover:scale-110 transition-transform duration-300'>
                <Camera size={22} />
              </div>
              <span className='text-lg'>Chia sẻ ảnh và câu chuyện du lịch</span>
            </div>
            <div className='flex items-center gap-4 text-emerald-100 group hover:text-white transition-colors duration-300'>
              <div className='p-2 bg-white bg-opacity-20 rounded-lg group-hover:scale-110 transition-transform duration-300'>
                <Globe size={22} />
              </div>
              <span className='text-lg'>Khám phá gợi ý từ cộng đồng</span>
            </div>
            <div className='flex items-center gap-4 text-emerald-100 group hover:text-white transition-colors duration-300'>
              <div className='p-2 bg-white bg-opacity-20 rounded-lg group-hover:scale-110 transition-transform duration-300'>
                <Mountain size={22} />
              </div>
              <span className='text-lg'>Lên kế hoạch chuyến đi hoàn hảo</span>
            </div>
          </div>
        </div>
          ...
          <div className='relative'>
            <div className='w-80 h-60 bg-gradient-to-t from-white/10 to-white/5 rounded-3xl backdrop-blur-sm border border-white/20 flex items-center justify-center relative overflow-hidden'>
              ...
              <div className='relative z-10 flex items-center justify-center'>
                <Globe size={60} className='text-white/80' />
              </div>
              ...
              {/* Small travel icons */}
              <Plane size={20} className='absolute top-8 left-1/4 text-white/60 animate-bounce' />
              <MapPin size={18} className='absolute bottom-12 right-8 text-white/60 animate-pulse' />
              <Camera size={16} className='absolute top-1/3 right-6 text-white/60 animate-ping' />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className='relative z-10'>
          ...
          <div className='flex flex-col gap-6'>
            ...
            <div className='space-y-3'>
              ...
              <div className='relative group'>
                <div className='absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none'>
                  <Mail size={22} className='text-gray-400 group-focus-within:text-emerald-500 transition-colors duration-200' />
                </div>
                <input
                  type='email'
                  name='email'
            ...
            <div className='flex gap-4'>
              ...
              <div className='flex-1 space-y-3'>
                ...
                <div className='relative group'>
                  <div className='absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none'>
                    <User size={22} className='text-gray-400 group-focus-within:text-emerald-500 transition-colors duration-200' />
                  </div>
                  <input
                    type='text'
                    name='fullName'
          ...
          <div className='space-y-4 mb-10'>
            <button className='w-full flex items-center justify-center gap-4 py-4 px-6 bg-gray-50 border-2 border-gray-200 rounded-2xl hover:bg-white hover:border-emerald-300 hover:shadow-lg transform hover:scale-[1.01] transition-all duration-200 group'>
              ...
              <span className='font-semibold text-gray-700 group-hover:text-emerald-600 text-lg'>Đăng ký với Google</span>
            </button>
            <button className='w-full flex items-center justify-center gap-4 py-4 px-6 bg-gray-50 border-2 border-gray-200 rounded-2xl hover:bg-white hover:border-emerald-300 hover:shadow-lg transform hover:scale-[1.01] transition-all duration-200 group'>
              <div className='w-6 h-6 bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg flex items-center justify-center'>
                <div className='w-3 h-3 bg-white rounded-sm'></div>
              </div>
              <span className='font-semibold text-gray-700 group-hover:text-emerald-600 text-lg'>Đăng ký với Facebook</span>
            </button>
          </div>
          ...
          <div className='text-center space-y-4'>
            ...
            <Link to='/login'>
            <button className='w-full py-4 px-8 bg-white border-3 border-emerald-600 text-emerald-600 font-bold rounded-2xl hover:bg-emerald-600 hover:text-white hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 text-lg'>
              <div className='flex items-center justify-center gap-2'>
                <span>Đăng nhập</span>
                <Plane size={20} />
              </div>
